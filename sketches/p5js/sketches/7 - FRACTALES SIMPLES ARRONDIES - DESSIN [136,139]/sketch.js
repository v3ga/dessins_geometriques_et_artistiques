...
//
// added : translate(5,-400);


// ----------------------------------------------------
let DESSIN = 136; // [136,137,138,139]
...
function setup() 
{
  ...
  X[0]=0;X[1]=0;;
  Y[0]=NP;Y[1]=-NP;
  L[0]=1/2;L[1]=1/4;L[2]=1/4;L[3]=1/4;L[4]=1/4;L[5]=1/2;L[6]=1/2;
  A[0]=0;A[1]=PI/2;A[2]=-PI;A[3]=0;A[4]=PI/2;A[5]=-PI/2;A[6]=0;  
